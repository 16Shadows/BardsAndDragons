...
const OutgoingFriendRequestsList = () => {
    ...
    return (
        <div className="bg-secondary-subtle p-2">
        {
            friendsList ? 
            friendsList.map(x => {
                return <OutgoingFriendRequestItem friend={x} key={x.username}/>;
            }) :
            <span>Загрузка...</span>
        }
        </div>
...
export default OutgoingFriendRequestsList;